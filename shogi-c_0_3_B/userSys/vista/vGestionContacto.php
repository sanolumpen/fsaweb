                ...
                <div class="card-box table-responsive">
                    ...
                    <table id="datatable" class="table table-bordered" style="width:100%;">
                        ...
                        <tbody style="color:#fff;background-color:#555">
                            <?php foreach ($tablaContacto as $key => $value) : ?>
                                <tr>
                                    <td><?php echo $value['idContacto']; ?></td>
                                    ...
                                    <td>
                                        <button onclick="eliminar('<?php echo $value['NombreC']; ?>', '<?php echo $value['IdContacto']; ?>');" title="Eliminar" type="button" name="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target=".bs-example-modal-sm">
